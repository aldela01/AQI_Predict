...
def main():
    ...
    parser = argparse.ArgumentParser(description='Concatenate SIATA station data files.')
    ...
    for file in files:
        ...
        if unnamed_columns:
            print(f'Unnamed columns detected in {file} in the positions {unnamed_columns}')
